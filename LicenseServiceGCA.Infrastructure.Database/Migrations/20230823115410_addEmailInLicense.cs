...
{
    public partial class addEmailInLicense : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hash = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LicenseEnd = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsLicensed = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    OpenToken = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
